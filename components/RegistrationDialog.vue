...
<template>
  <Dialog v-if="props.isSignUpSuccess" :open="props.isRegisterDialogOpen"
    ...
    <DialogContent class="max-w-[600px]">
      <DialogHeader>
        <DialogTitle class="text-2xl text-center leading-loose"><span
            ...
            !</span> <br> Thanks for signing up <span class="font-bold capitalize">{{ props.username
            }}</span> !
        </DialogTitle>
      </DialogHeader>
  ...
  <!--Dialog Error-->
  <Dialog v-else v-model:open="props.isRegisterDialogOpen">
    <DialogContent class="max-w-[600px]">
      <DialogHeader>
        <DialogTitle class="text-2xl text-center leading-loose"><span
