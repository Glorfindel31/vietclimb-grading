...
watch(
  ...
  (newValues) => {
    ape_index.value
			= newValues.arms && newValues.height
			  ? newValues.arms - newValues.height
			  : 0
  },
  { deep: true },
...
ape_index.value
	= values.arms && values.height ? values.arms - values.height : 0
</script>
  ...
  >
    <div class="flex flex-col">
      ...
      >
        ...
        >
          <FormItem
            class="flex flex-row items-center gap-2 space-y-0 p-2"
          >
            <div class="flex w-full flex-col gap-2">
              <FormLabel class="text-md font-bold">
                UserName
              </FormLabel>
              <FormDescription>
        ...
        >
          <FormItem
            class="flex flex-row items-center gap-4 space-y-0 p-2"
          >
            <div class="flex w-full flex-col gap-2">
              <FormLabel class="text-md font-bold">
                Height
              ...
              <FormDescription>
                Your height will be displayed to other
                users in cm and used to compute your ape
                index.
              </FormDescription>
            </div>
            <div class="flex w-80 flex-col">
        ...
        >
          ...
          >
            <div class="flex w-full flex-col gap-2">
              ...
              <FormDescription>
                Your arms length will be displayed to
                other users in cm and used to compute
                your ape index. (Both arms in a T pose
                measured from finger to finger).
              </FormDescription>
            </div>
            <div class="flex w-80 flex-col">
              <FormControl>
        ...
        >
          ...
          >
            <div class="flex w-full flex-col gap-2">
              ...
              <FormDescription>
                Your birthdate will be displayed to
                other users.
              </FormDescription>
            </div>
            <div class="flex w-80 flex-col">
        ...
        >
          <div class="m-0 flex flex-col justify-between">
            ...
            <span class="w-1/2 text-sm text-muted-foreground">
              Your Ape index is the relational size between
              your arms size and your height. It can be
