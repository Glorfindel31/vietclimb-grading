          ...
          <FormField v-slot="{ componentField }" name="arms">
            ...
            >
              <div class="flex w-full flex-col gap-2">
                ...
                <FormDescription>
                  Your arms length will be displayed to other users in cm and
                  used to compute your ape index. (Both arms in a T pose
          ...
          >
            <div class="m-0 flex flex-col justify-between">
              ...
              <span class="w-1/2 text-sm text-muted-foreground">
                ...
                your height. It can be positive or negative
              </span>
            </div>
            <span
